//
//  UHPsychologicalAssessmentSmokeCell.m
//  Uhealth
//
...
@interface UHPsychologicalAssessmentSmokeCell()<UITableViewDelegate,UITableViewDataSource>
{
    UILabel *_titleLabel;
    UIButton *_arrowBtn;
    UITableView *_tableView;
    NSMutableArray *_data;
    UHPsySelectTypeCell *_cell;
}

@end

@implementation UHPsychologicalAssessmentSmokeCell
