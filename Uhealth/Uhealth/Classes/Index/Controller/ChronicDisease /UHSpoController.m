...
@interface UHSpoController ()<UITableViewDelegate,UITableViewDataSource>
...
//spo数组
@property (nonatomic,strong) NSMutableArray *spoData;
//时间数组
@property (nonatomic,strong) NSMutableArray *dateArr;
@property (nonatomic,copy) NSString *btnType;
@end

@implementation UHSpoController
...
- (void)setupRefresh {
    ...
    tableView.mj_header= [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        //血氧查询
        [[ZPNetWorkTool sharedZPNetWorkTool] GETRequestWith:@"spo" parameters:@{@"btnType":self.btnType} progress:^(NSProgress *progress) {
...
//                        NSString *str = [dateformatter stringFromDate:resDate];
        ...
        } className:[UHSpoController class]];
    }];
...
- (void)initAll {
    ...
    [self.headView sd_addSubviews:@[self.bloodLabel,self.stateLabel,self.fromLabel,self.checkLabel,self.timeLabel]];
...
- (PYOption *)standardLineOption {
    return [PYOption initPYOptionWithBlock:^(PYOption *option) {
        ...
        .addSeries([PYSeries initPYSeriesWithBlock:^(PYSeries *series) {
            ...
            .dataEqual([[self.spoData reverseObjectEnumerator] allObjects])
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.spoModel = self.data[indexPath.row];
...
- (void)enterBloodValue {
    __weak typeof(self) weakSelf = self;
    UHSpoEnteringController *enterControl = [[UHSpoEnteringController alloc] init];
...
- (NSMutableArray *)spoData {
    if (!_spoData) {
        _spoData = [NSMutableArray array];
    }
    return _spoData;
}
