...
@interface UHBMIController ()<UITableViewDelegate,UITableViewDataSource>
...
//体脂率数组
@property (nonatomic,strong) NSMutableArray *bmiData;
//时间数组
...
@implementation UHBMIController
...
- (void)setupRefresh {
    ...
    tableView.mj_header= [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        //血氧查询
        [[ZPNetWorkTool sharedZPNetWorkTool] GETRequestWith:@"bodyIndex" parameters:@{@"btnType":self.btnType} progress:^(NSProgress *progress) {
        ...
        } className:[UHBMIController class]];
    }];
...
- (PYOption *)standardLineOption {
    return [PYOption initPYOptionWithBlock:^(PYOption *option) {
        ...
        .addSeries([PYSeries initPYSeriesWithBlock:^(PYSeries *series) {
            ...
            .dataEqual([[self.bmiData reverseObjectEnumerator] allObjects])
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.bodyIndexModel = self.data[indexPath.row];
...
- (void)enterBloodValue {
    UHBMIEnteringController *enterControl = [[UHBMIEnteringController alloc] init];
