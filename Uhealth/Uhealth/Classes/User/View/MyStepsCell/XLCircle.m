...
//    backLayer.strokeColor  = [UIColor colorWithRed:50.0/255.0f green:50.0/255.0f blue:50.0/255.0f alpha:1].CGColor;
    backLayer.strokeColor  = [[UIColor whiteColor] colorWithAlphaComponent:0.66].CGColor;
...
//    [self.layer addSublayer:gradientLayer];
    ...
    _endPoint.frame = CGRectMake(0, 0, 15,15);
    _endPoint.hidden = true;
    _endPoint.backgroundColor = [UIColor clearColor];
    _endPoint.image = [UIImage imageNamed:@"endPoint1"];
