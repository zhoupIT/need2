...
//        }
    ...
    [_picPathStringsArray enumerateObjectsUsingBlock:^(NSString *  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        imageView.hidden = NO;
        [imageView sd_setImageWithURL:[NSURL URLWithString:obj] placeholderImage:[UIImage imageNamed:@"placeholder_comment"]];
...
//        CGFloat w = [UIScreen mainScreen].bounds.size.width > 320 ? 80 : 70;
        CGFloat w = ([UIScreen mainScreen].bounds.size.width -30 -5*3)/3;
        return w;
    }
}
