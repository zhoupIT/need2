...
//cell分割线默认高度
#define HS_KSeparateHeight 1
//cell分割线默认颜色
#define HS_KSeparateColor [UIColor hs_colorWithHexString:@"#f2f2f2"]
//标题默认字体大小
#define HS_KTitleFont  [UIFont systemFontOfSize:15.0]
//标题默认字体颜色
#define HS_KTitleColor  [UIColor blackColor]
//详细文本默认字体大小
#define HS_KDetailFont [UIFont systemFontOfSize:15.0]
//标题默详细文本字体颜色
#define HS_KDetailColor  [UIColor hs_colorWithHexString:@"#aaaaaa"]
//分组section之间的距离
...
//箭头默认高度
#define HS_kArrowHeight 15
//右边文本离左边的边距
#define HS_KCellTextLeftPading  150
//距离cell上下默认边距pading
#define HS_KCellPading  18
//cell默认高度
#define HS_KCellHeight 49
//开关默认宽度
