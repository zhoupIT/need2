...
//168
static CGFloat const kCommentTextViewHeight = 50.0;
...
//    self.commentTextView.delegate = self;
    self.editView.layer.cornerRadius = 35*0.5;
...
- (void)keyboardWasShown:(NSNotification *)aNotification {
    ...
    if (kbSize.height > kMininumKeyboardHeight) {
        self.containerViewConstraintHeight.constant = kCommentTextViewHeight + kbSize.height;
    } else {
        self.containerViewConstraintHeight.constant = kCommentTextViewHeight + kMininumKeyboardHeight;
    }
}
